...
namespace ImmRequest.WebApi.Tests.ControllerTests
{
    ...
    public class CitizenRequestControllerTest
    {
        ...
        public void CreateCitizenRequest()
        {
            ...
            var mockAreaFinder = new Mock<IFinder>(MockBehavior.Strict);

            mockCitizenRequestLogic.Setup(m => m.Create(It.IsAny<CitizenRequest>()));

            var controller = new CitizenRequestController(mockCitizenRequestLogic.Object, finderMock.Object);
        ...
        public void GetAllAreas()
        {
            ...
            mockAreaFinder.Setup(m => m.FindAll<Area>())
        ...
        public void GetAllTopicsFromArea()
        {
            ...
            finderMock.Setup(m => m.FindAll(It.IsAny<Predicate<Topic>>()))
